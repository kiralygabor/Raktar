...
class DBStores extends DB implements StoresInterface
{
    ...
    public function createTable(){
        $query = 'CREATE TABLE IF NOT EXISTS stores (id int AUTO_INCREMENT PRIMARY KEY, name varchar(35) NOT NULL, shelfs varchar(10), shelf_lines varchar(10), buildings_id int NOT NULL);';
